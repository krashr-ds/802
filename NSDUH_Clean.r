# Clean NSDUH Data
  ...
  NSDUH_2002_2017_Edited_Joined_2 <- read.csv("/home/kylier/Windows/803/NSDUH_2002_2017_Edited_Joined_2.csv", colClasses = "character")
  ...
  twoCodeRecodes <- c("HERDYSPERMO", "MTHDAYSPERMO", "ADWHODAS")
  
  NSDUH_2002_2017_Clean <- NSDUH_2002_2017_Clean %>%
  ...
  ZeroOneCols <- c("HYDROCOD", "METHADON", "MORPHINE", "METHAMPH", "RITALIN", "TRNEVERTRIED", "APPBYSELLMO", "DIFOBTMRJ", "YTHMHTALKYR", "ADSMI",
                   "DIFOBTCOC", "DIFOBTCRK", "DIFOBTHER", "DEPNDALC", "DEPNDMRJ", "DEPNDANL", "DEPNDCOC", "DEPNDHER", "DEPNDANYDYR", "DEPNDHARDDYR", "YTHSMI",
  ...
  ASSNCols <- c("TEACHERENCYR", "PARENTSCHECKYR", "CHORESYR", "TVLIMITYR", "FRIENDLIMITYR", "PARENTENCYR", "PARENTPRDYR")
  NSDUH_2002_2017_Clean <- NSDUH_2002_2017_Clean %>%
...
# Copy
NSDUH_2002_2017_Clean_Gathered <- NSDUH_2002_2017_Clean

# Gather data on difficulty of obtaining drugs
NSDUH_2002_2017_Clean_Gathered <- NSDUH_2002_2017_Clean_Gathered %>% 
  gather(OBTSUBSTANCE, OBTSUBSTANCEDIFRATING, c(DIFGETMRJ, DIFGETCOC, DIFGETCRK, DIFGETHER))


NSDUH_2002_2017_Clean_Gathered <- NSDUH_2002_2017_Clean_Gathered %>% mutate(OBTSUBSTANCE = recode(OBTSUBSTANCE,
                                         DIFGETMRJ = "MARIJUANA",
                                         DIFGETCOC = "COCAINE",
                                         DIFGETCRK = "CRACK",
                                         DIFGETHER = "HEROIN"))
...
NSDUH_2002_2017_Clean_Gathered <- NSDUH_2002_2017_Clean_Gathered %>% 
  gather(OBTSUBSTANCEBIN, OBTSUBSTANCEBINRATING, c(DIFOBTMRJ, DIFOBTCOC, DIFOBTCRK, DIFOBTHER))


NSDUH_2002_2017_Clean_Gathered <- NSDUH_2002_2017_Clean_Gathered %>% mutate(OBTSUBSTANCEBIN = recode(OBTSUBSTANCEBIN,
                                         DIFOBTMRJ = "MARIJUANA",
                                         DIFOBTCOC = "COCAINE",
                                         DIFOBTCRK = "CRACK",
                                         DIFOBTHER = "HEROIN"))

# Gather data on dependency
#NSDUH_2002_2017_Clean_Gathered <- NSDUH_2002_2017_Clean_Gathered %>% 
#  gather(DEPND, DEPNDSUBSTANCE, c(DEPNDALC, DEPNDANL, DEPNDCOC, DEPNDHER, DEPNDMRJ))


#NSDUH_2002_2017_Clean_Gathered <- NSDUH_2002_2017_Clean_Gathered %>% mutate(DEPND = recode(DEPND,
#                                         DEPNDALC = "ALCOHOL",
#                                         DEPNDMRJ = "MARIJUANA",
#                                         DEPNDCOC = "COCAINE",
#                                         DEPNDANL = "OPIATES",
...
# Gather data on parent behaviors
#NSDUH_2002_2017_Clean_Gathered <- NSDUH_2002_2017_Clean_Gathered %>% 
#  gather(PARENTBEH, PARENTBEHRESULT, c(PARENTSCHECKYR, CHORESYR, TVLIMITYR, FRIENDLIMITYR,PARENTENCYR, PARENTPRDYR))


#NSDUH_2002_2017_Clean_Gathered <- NSDUH_2002_2017_Clean_Gathered %>% mutate(PARENTBEH = recode(PARENTBEH,
#                                         PARENTSCHECKYR = "CHECKED HW",
#                                         CHORESYR = "ASSIGNED CHORES",
#                                         TVLIMITYR = "LIMITED SCREENS",
#                                         FRIENDLIMITYR = "LIMITED FRIENDS",
#                                         PARENTENCYR = "ENCOURAGED",
#                                         PARENTPRDYR = "PROUD OF"))

# Gather data on school behaviors
#NSDUH_2002_2017_Clean_Gathered <- NSDUH_2002_2017_Clean_Gathered %>% 
#  gather(SCHOOLBEH, SCHOOLBEHRESULT, c(TEACHERENCYR, DRUGEDSCHOOL))


#NSDUH_2002_2017_Clean_Gathered <- NSDUH_2002_2017_Clean_Gathered %>% mutate(SCHOOLBEH = recode(SCHOOLBEH,
#                                         TEACHERENCYR = "ENCOURAGED",
#                                         DRUGEDSCHOOL = "PROVIDED DRUG EDU"))
...
write.csv(NSDUH_2002_2017_Clean_Gathered, '/home/kylier/Documents/UNH/803/NSDUH_Clean_Gathered.csv')
